...
const Plan = () => {
  return (
    <div className="max-w-[1400px] m-auto pb-16 px-4 grid lg:grid-cols-2 gap-4 ">
      {/* Left Side */}
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="pb-6">
          ...
          dignissimos corporis ipsum ullam id odit. Doloribus a dolorem sapiente
          fuga delectus. Veritatis nostrum laboriosam, iure ipsam perferendis
          accusantium architecto suscipit?
        </p>
        <div className="mx-auto mt-6">
          <button className="border-black mr-4 hover:shadow-xl">
            Learn More
          </button>
          <button className="bg-gray-800 text-white border-black hover:shadow-xl">
            Book Your Trip
          </button>
        </div>
      </div>
